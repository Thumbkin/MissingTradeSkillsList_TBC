...
MTSLUI_LOCALES_LABELS = {
    ["addon loaded msg"] = {
        ...
        ["German"] = "Addon geladene Nachricht anzeigen",
        ["Russian"] = "Показать аддон загруженное сообщение",
        ["Korean"] = "애드온로드 메시지 표시",
        ["Chinese"] = "显示插件加载的消息",
        ["Taiwanese"] = "顯示插件加載的消息",
    ...
    ["link_to_chat"] = {
        ...
        ["German"] = "Verknüpfe Gegenstand mit dem Chat",
        ["Russian"] = "Ссылка на предмет для чата",
        ["Korean"] = "채팅 할 항목 연결",
        ["Chinese"] = "链接项目聊天",
    ...
    ["mtsl frame location"] = {
        ...
        ["German"] = "Position der Frame",
        ["Russian"] = "Расположение кадра",
        ["Korean"] = "프레임 위치",
        ["Chinese"] = "框架位置",
    ...
    ["ui scale"] = {
        ...
        ["German"] = "UI-Skala",
        ["Russian"] = "Шкала пользовательского интерфейса",
        ["Korean"] = "UI 규모",
        ["Chinese"] = "用户界面比例",
        ["Spanish"] = "Escala UI",
        ["Mexican"] = "Escala UI",
    ...
    ["ui split orientation"] = {
        ...
        ["Russian"] = "UI разделить ориентацию",
        ["Korean"] = "UI 분할 방향",
        ["Chinese"] = "UI分割方向",
